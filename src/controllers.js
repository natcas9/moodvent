...
export function viewCrearEvento(req, res) {
  res.render("paginas/crearEvento");
}
...
export function crearEvento(req, res) {
  ...
  res.redirect("/visualizarEventos"); //Donde se mostrarán todos los eventos
}

export function visualizarEventos(req, res) {
  res.render("paginas/visualizarEventos", { eventos });
}
